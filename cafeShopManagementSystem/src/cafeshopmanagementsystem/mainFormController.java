...
public class mainFormController implements Initializable {
    ...
    public void inventoryImportBtn() {
        ...
        openFile.getExtensionFilters().add(new ExtensionFilter("Open Image File", "*png", "*jpeg"));
    ...
    public void menuReceiptBtn() {
        ...
        if (totalP == 0 || menu_amount.getText().isEmpty()) {
            ...
            try {
                ...
                JasperDesign jDesign = JRXmlLoader.load("/Users/user/Desktop/jasperreports-6.20.5");
    ...
    public void logout() {
        ...
        try {
            ...
            if (option.get().equals(ButtonType.OK)) {
                ...
                stage.setTitle("Кафе дүкөнүн башкаруу системасы");
